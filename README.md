...
0. 在机器人的配置文件修改/加上IP或者域名配置，如果你的机器人配置文件没问题，应该会有下面三个值：
   ...
   注意：如果你没有公网IP，机器人自动获取的IP是无法访问到机器人的，请在局域网内使用`127.0.0.1`作为你的机器人的实际IP
...
7. 台服请使用**pcrjjc3-tw**：
   ...
   **pcrjjc3-tw:
   ** [由pcrjjc2修改而来的台服竞技场查询插件，额外支持了多服查询 (github.com)](https://github.com/azmiao/pcrjjc3-tw)
...
- 若运行过程中出现`TypeError: __init__() got an unexpected keyword argument 'strict_map_key'`
